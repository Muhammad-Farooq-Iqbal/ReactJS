...
const Digitalclock = () => {
  return (
    <>
        <div className="clock-container" style={{ color: 'black', backgroundColor: 'pink', padding: '20px', textAlign: 'center' }}>
        <h1>My Clock</h1>
        <Clock />
        <button className='btn btn-danger' style={{cursor:'pointer'}}>hey everyone</button>
